                ...
                <main>
                    <div className={styles.content}>
                        <div className="p-6 w-full text-noble-black-0 flex flex-col gap-2 text-font-l leading-6">
                            <h1 className="text-3xl font-extrabold text-noble-black-200">Terms and Conditions</h1>
                            <p className="text-m">Last updated December 20, 2023</p>
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4">
                                AGREEMENT TO OUR LEGAL TERMS
                            </h2>
                            <p>
                                We are VoxiVerse (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;).
                            </p>
                            <p>
                                We operate the website https://www.voxiverse.com (the &quot;Site&quot;), as well as any
                                other related products and services that refer or link to these legal terms (the
                                &quot;Legal Terms&quot;) (collectively, the &quot;Services&quot;).
                            </p>
                            <p>You can contact us by email at support@voxiverse.com.</p>
                            <p>
                                These Legal Terms constitute a legally binding agreement made between you, whether
                                personally or on behalf of an entity (&quot;you&quot;), and VoxiVerse, concerning your
                            ...
                            <ol className="list-decimal list-inside flex-col flex gap-3">
                                ...
                                <li>
                                    <Link href="#intellectual-property-rights">INTELLECTUAL PROPERTY RIGHTS</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="#purchases-and-payment">PURCHASES AND PAYMENT</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="#user-generated-contributions">USER GENERATED CONTRIBUTIONS</Link>
                                </li>
                                <li>
                                    <Link href="#contributions-license">CONTRIBUTIONS LICENSE</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="#modifications-and-interruptions">MODIFICATIONS AND INTERRUPTIONS</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="#electronic-communications">ELECTRONIC COMMUNICATIONS</Link>
                                </li>
                                <li>
                                    <Link href="#california-users-and-residents">CALIFORNIA USERS AND RESIDENTS</Link>
                                </li>
                                <li>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="our-services">
                                1. OUR SERVICES
                            </h2>
                            <p>
                            ...
                            <p>
                                VoxiVerse provides an interactive chat platform featuring a diverse array of parody AI
                                characters drawn from movies, TV shows, anime, video games, and real-life figures. These
                                characters are designed for entertainment purposes and are not intended to be accurate
                                impersonations of the original entities. Users engage with these characters through text
                                and voice inputs, receiving responses in both text and bespoke audio formats.
                            </p>
                            <p>
                                Upon registering for a VoxiVerse membership at a cost of $15 per month, members are
                                entitled to send up to 20 messages daily, with this quota resetting at 00:00 UTC.
                                Members may also purchase an additional &quot;message credit&quot; package for $5,
                                granting an extra 20 messages. These additional credits do not expire and are utilized
                                subsequent to the exhaustion of the daily subscription credits. Please note, VoxiVerse
                            ...
                            <h4 className="text-lg font-bold text-noble-black-200">Our intellectual property</h4>
                            <p>
                            ...
                            <h4 className="text-lg font-bold text-noble-black-200">Your use of our Services</h4>
                            <p>
                                Subject to your compliance with these Legal Terms, including the{" "}
                                <Link href="#prohibited-activities">&quot;PROHIBITED ACTIVITIES&quot;</Link> section
                            ...
                            <p>
                                ...
                                support@voxiverse.com. If we ever grant you the permission to post, reproduce, or
                            ...
                            <h4 className="text-lg font-bold text-noble-black-200">Your submissions</h4>
                            <p>
                            ...
                            <ul className="list-disc list-inside flex-col flex gap-3">
                                <li>
                                    ...
                                    <Link href="#prohibited-activities">&quot;PROHIBITED ACTIVITIES&quot;</Link> and
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="user-representations">
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="user-registration">
                                4. USER REGISTRATION
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="purchases-and-payment">
                            ...
                            <ul className="list-disc list-inside flex-col flex gap-3">
                                ...
                                <li>Apple Pay</li>
                                <li>Google Pay</li>
                                <li>Other Stripe supported payment methods</li>
                            </ul>
                            <p>
                            ...
                            <p>
                                In the event of service failure, you may be eligible for a refund. Refund eligibility
                                will be determined by our customer service team upon reviewing the circumstances of the
                                service failure. Please contact support@voxiverse.com to request a refund.
                            </p>
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="policy">
                                6. POLICY
                            </h2>
                            <p>
                                All transactions are final and non-refundable. Members may cancel their subscription at
                                any time. Cancellation can be executed through the user&quot;s profile settings, under
                                the &quot;Manage your subscription&quot; section, whereupon they will be redirected to
                                the Stripe page for processing.
                            </p>
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="prohibited-activities">
                            ...
                            <ul className="list-disc list-inside flex-col flex gap-3">
                                ...
                                <li>Delete the copyright or other proprietary rights.</li>
                                <li>
                            ...
                            <p>
                                ...
                                may be viewable by other users of the Services and through third-party websites. When
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="contributions-license">
                                9. CONTRIBUTIONS LICENSE
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="social-media">
                                10. SOCIAL MEDIA
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="services-management">
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="privacy-policy">
                                13. PRIVACY POLICY
                            </h2>
                            <p>
                                ...
                                Please be advised the Services are hosted in the United States. If you access the
                                ...
                                United States, then through your continued use of the Services, you are transferring
                                your data to the United States, and you expressly consent to have your data transferred
                                to and processed in the United States. Further, we do not knowingly accept, request, or
                            ...
                            <p>
                                Please refer to our Privacy Policy for detailed information on how we collect, use,
                                protect, and store your personal data. Our Privacy Policy is designed to ensure a high
                                level of protection for your personal data, in compliance with the laws and regulations
                                of Ontario, Canada.
                            </p>
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="term-and-termination">
                            ...
                            <p>
                                ...
                                injunctive redress. Membership is contingent upon timely payment of the monthly
                                subscription fee. Failure to maintain regular payments will result in the termination of
                                membership services.
                            </p>
                            <h2
                                className="text-xl font-bold text-noble-black-200 mt-4"
                            ...
                            <p>
                                We aim to provide the Services on a continuous basis. However, the availability of the
                                Services may be affected by factors outside of our control. We will strive to inform
                                users of any significant interruptions and to restore the service as quickly as
                                possible.
                            </p>
                            <p>
                                Significant changes to the Services will be announced on our website. We encourage you
                                to regularly check our website for any such announcements.
                            </p>
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="governing-law">
                                16. GOVERNING LAW
                            </h2>
                            <p>
                                These Legal Terms shall be governed by and defined following the laws of Ontario,
                                Canada. VoxiVerse and yourself irrevocably consent that the courts of Ontario, Canada,
                                shall have exclusive jurisdiction to resolve any dispute which may arise in connection
                                with these Legal Terms.
                            </p>
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="dispute-resolution">
                                17. DISPUTE RESOLUTION
                            </h2>
                            <h4 className="text-lg font-bold text-noble-black-200">Informal Negotiations</h4>
                            <p>
                            ...
                            <h4 className="text-lg font-bold text-noble-black-200">Binding Arbitration</h4>
                            <p>
                                ...
                                clause. The number of arbitrators shall be one (1). The seat, or legal place, or
                                arbitration shall be Ottawa, Canada. The language of the proceedings shall be English.
                                The governing law of these Legal Terms shall be substantive law of Canada.
                            </p>
                            <h4 className="text-lg font-bold text-noble-black-200">Restrictions</h4>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="corrections">
                                18. CORRECTIONS
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="disclaimer">
                                19. DISCLAIMER
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="limitation-of-liability">
                            ...
                            <p>
                                ...
                                AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6)
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="indemnification">
                                21. INDEMNIFICATION
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="user-data">
                                22. USER DATA
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="electronic-communications">
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="miscellaneous">
                                25. MISCELLANEOUS
                            </h2>
                            <p>
                            ...
                            <h2 className="text-xl font-bold text-noble-black-200 mt-4" id="contact-us">
                                26. CONTACT US
                            </h2>
                            <p>
                            ...
                            <div className="flex flex-col">
                                <strong>VoxiVerse</strong>
                                <strong>Canada</strong>
                                <strong>support@voxiverse.com</strong>
                            </div>
                        </div>
                        <Footer />
                    </div>
